...
function initGame() {
    ...
    style.innerHTML = `
        ...
        @media (max-width: 768px) {
            ...
            /* اصلاح ایموجی‌های سنگ و چوب در موبایل (کوچک کردن بدون برش) */
            .resource-icon { 
                ...
                align-items: center !important;
                justify-content: center !important;
                transform: scale(0.8) !important; /* کوچک کردن بصری ایموجی‌ها */
                transform-origin: center !important;
                margin: 0 -1px !important; /* جبران فاصله ایجاد شده توسط اسکیل */
            }
...
window.onload = initGame;    if (!modal) {
        modal = document.createElement('div');
        modal.id = 'saveNameModal';
        modal.style.cssText = "position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.95); z-index: 7000; display: none; justify-content: center; align-items: center; font-family: 'Vazirmatn', sans-serif;";
        modal.innerHTML = `
